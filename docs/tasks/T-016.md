# T-016: System schema YAML (simplicity-schema)

- **Status**: DONE
- **Milestone**: M1 — Foundation
- **PRD Reference**: §5 (US-002)
- **Commit**: d1dc8e119ee7db2b121d5eaf67ade894266a19aa
- **Depends**: T-009
- **Produces**:
...
- **Tests**: `packages/db/tests/schema-validation.test.ts` (integration)
  - `simplicity-schema validate` passes against an empty DB
  - YAML files parse correctly
- **AC**: All system schema YAML files are valid simplicity-schema definitions
