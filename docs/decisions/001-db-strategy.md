...
Schema management uses `@smplcty/schema-flow` for declarative DDL via YAML files. schema-flow handles table creation, enum management, role definitions, RLS policies, column-level grants, triggers, functions, and zero-downtime migrations.
