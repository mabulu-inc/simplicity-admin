...
declare module '$env/static/private' {
	...
	export const npm_config__digital_plant_registry: string;
	...
	export const npm_config__mabulu_inc_registry: string;
	...
	export const npm_package_dependencies__simplicity_admin_core: string;
	export const npm_package_devDependencies_vitest: string;
	export const npm_config__mabulu_registry: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config__digital_plant_registry: string;
		PNPM_HOME: string;
		GIT_EDITOR: string;
		USER: string;
		NVM_DIR: string;
		...
		npm_config__mabulu_inc_registry: string;
		...
		npm_package_dependencies__simplicity_admin_core: string;
		npm_package_devDependencies_vitest: string;
		npm_config__mabulu_registry: string;
